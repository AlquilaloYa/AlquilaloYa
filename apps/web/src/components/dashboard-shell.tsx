...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/google/docs", label: "Google Docs", icon: FileText, section: "Google SyS", group: "google" },
  { href: "/google/tasks", label: "Google Tasks", icon: ListTodo, section: "Google SyS", group: "google" },
];
